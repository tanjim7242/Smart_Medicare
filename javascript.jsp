...
<script src="${pageContext.request.contextPath}/resources/theme/js/detect.js"></script>
<script src="${pageContext.request.contextPath}/resources/theme/js/fastclick.js"></script>
...
<script src="${pageContext.request.contextPath}/resources/theme/js/jquery.circliful.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/theme/js/jquery.core.js"></script>
<script src="${pageContext.request.contextPath}/resources/theme/js/jquery.counterup.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/theme/js/jquery.dashboard.js"></script>
...
<script src="${pageContext.request.contextPath}/resources/theme/js/jquery.sparkline.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/theme/js/jquery.waypoints.js"></script>
<script src="${pageContext.request.contextPath}/resources/theme/js/modernizr.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/theme/js/skycons.min.js"></script>
...
<script src="${pageContext.request.contextPath}/resources/theme/js/fullcalendar.js"></script>

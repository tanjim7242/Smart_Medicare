 ...
 <%@ include file="homeheader.jsp"%> 
        ...
        <div class="wrapper">
          ...
          <%--   background-image: src("${pageContext.request.contextPath}/resources/theme/img/websitebg.png"); --%>
                ...
                <h4 class="text-success counter" align="center">Pharmacy Registration Form</h4>
                <!-- Page-Title -->
		...
		<div class="alert alert-${css} alert-dismissible" role="alert">
			...
			<strong>${msg}</strong>
                        ...
                        <div class="card-box">
                              ...
                              <div class="col-md-4">
                                  <div class="form-group">
                                       <label for="inputdefault">Pharmacy  Name</label>
                                  ...
                                  <div class="form-group">
                                       <label for="inputdefault">Pharmcy Oner frist  Name</label>
                                  ...
                                  <div class="form-group">
                                       <label for="inputdefault">Pharmcy Oner frist Last Name</label>
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="form-group">
	    						...
	    						<div class="form-group">
								    ...
								    <div class="form-group">
                                       <label for="inputdefault">Pharmacy Registation number</label>

 ...
 <%@ include file="homeheader.jsp"%> 
        ...
        <div class="wrapper">
          ...
          <%--   background-image: src("${pageContext.request.contextPath}/resources/theme/img/websitebg.png"); --%>
                ...
                <h4 class="text-success counter" align="center">Patient Registration Form</h4>
                <!-- Page-Title -->
		...
		<div class="alert alert-${css} alert-dismissible" role="alert">
			...
			<strong>${msg}</strong>
                              ...
                              <div class="col-md-4">
                                  ...
                                  <div class="form-group">
                                   ...
                                   <div class="form-group">
		  							...
		  							<form:errors path="gender" class="text-danger" name="gender_error"/>
								 </div> 
                      ...
                      <div class="form-group">
									...
									placeholder="MM/DD/YYY" required="true"/>	
										
										<form:errors path="birthday" class="text-danger" name="email_name_error"/>
								    </div>   
                               ...
                               <div class="form-group">
                                       <label for="inputdefault">Home Address</label>
	    						...
	    						<div class="form-group">
								    ...
								    <div class="form-group">
                                       <label for="inputdefault">Age</label>
										...
										<form:errors path="age" class="text-danger" name="age_error"/>
								    </div> 
								    <div class="form-group">
                                       <label for="inputdefault">Post Office</label>
     ...
     --%>
    						 <div class="form-group">
								  ...
								  <li><a href="${pageContext.request.contextPath}/doctor/prescrition">Login here</a> 
							</div>

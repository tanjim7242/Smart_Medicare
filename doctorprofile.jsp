                        ...
                        <div class="text-center card-box">
                            <div class="member-card">
                                ...
                                <div class="text-left m-t-40">
                                    <p class="text-muted font-13"><strong>Full Name :</strong> <span class="m-l-15">${report.firstname} ${report.firstname}</span></p>

                                    <p class="text-muted font-13"><strong>Mobile :</strong><span class="m-l-15">${report.phone}</span></p>

                                    <p class="text-muted font-13"><strong>Email :</strong> <span class="m-l-15">${report.email}</span></p>
                                    ...
                                    <div class="tab-pane" id="settings">
                                        <form role="form">
                                            <div class="form-group">
                                                ...
                                                <input value="John Doe" id="FullName" class="form-control" type="text">
                                            </div>
                                            <div class="form-group">
                                                <label for="Email">Email</label>
                                                <input value="first.last@example.com" id="Email" class="form-control" type="email">
                                            </div>
                                            <div class="form-group">
                                                <label for="Username">Username</label>
                                                <input value="john" id="Username" class="form-control" type="text">
                                            </div>
                                            <div class="form-group">
                                                <label for="Password">Password</label>
                                                <input placeholder="6 - 15 Characters" id="Password" class="form-control" type="password">
                                            </div>
                                            <div class="form-group">
                                                <label for="RePassword">Re-Password</label>
                                                <input placeholder="6 - 15 Characters" id="RePassword" class="form-control" type="password">
                                            </div>
                                            <div class="form-group">
